...
public class Kategori2Adapter extends RecyclerView.Adapter<Kategori2Adapter.ViewHolder>   {

    private ArrayList<HashMap<String, String>> data;
    private Activity activity;

    public Kategori2Adapter(Activity activity, ArrayList<HashMap<String, String>> data) {
        this.data=data;
        this.activity = activity;
    }

    @Override
    public Kategori2Adapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {

        //inflate your layout and pass it to view holder
        LayoutInflater inflater = activity.getLayoutInflater();
        View view = inflater.inflate(R.layout.cardview_kategori, viewGroup, false);
        Kategori2Adapter.ViewHolder viewHolder = new Kategori2Adapter.ViewHolder(view);

        return viewHolder;
    }

    @Override
    public void onBindViewHolder(final Kategori2Adapter.ViewHolder viewHolder, final int i) {
    ...
    protected class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            new_indicatior=view.findViewById(R.id.new_indicatior2);
            image=view.findViewById(R.id.image2);
            ll_kategori = view.findViewById(R.id.ll_kategori2);
            linear_item_kategori = view.findViewById(R.id.linear_item_kategori2);
