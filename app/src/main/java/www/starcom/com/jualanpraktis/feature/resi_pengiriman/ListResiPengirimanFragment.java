...
import www.starcom.com.jualanpraktis.adapter.ResiAdapter;
import www.starcom.com.jualanpraktis.databinding.FragmentListResiPengirimanBinding;

/**
 * A simple {@link Fragment} subclass.
 */
public class ListResiPengirimanFragment extends Fragment {

    public ListResiPengirimanFragment() {
        // Required empty public constructor
    }
    FragmentListResiPengirimanBinding binding;
    String url = "https://jualanpraktis.net/android/resi.php";
    loginuser user ;
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            adapter = new ResiAdapter(getActivity(),dataList);
