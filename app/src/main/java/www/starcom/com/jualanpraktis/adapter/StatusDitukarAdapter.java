...
public class StatusDitukarAdapter extends RecyclerView.Adapter<StatusDitukarAdapter.StatusDitukarViewHolder> {

    Context context;
    ArrayList<HashMap<String, String>> listStatusDitukar = new ArrayList<>();
    private Pref pref;

    String id_transaksi;

    public StatusDitukarAdapter(Context context, ArrayList<HashMap<String, String>> listStatusDitukar) {
        this.context = context;
        this.listStatusDitukar = listStatusDitukar;
    }

    @NonNull
    @Override
    public StatusDitukarViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_status_transaksi, parent, false);
        return new StatusDitukarViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull StatusDitukarViewHolder holder, int position) {
        HashMap<String, String> item = new HashMap<>();
        item = this.listStatusDitukar.get(position);
    ...
    public int getItemCount() {
        return (null != listStatusDitukar ? listStatusDitukar.size() : 0);
    }

    public class StatusDitukarViewHolder extends RecyclerView.ViewHolder {
        ...
        public StatusDitukarViewHolder(@NonNull View itemView) {
            super(itemView);
